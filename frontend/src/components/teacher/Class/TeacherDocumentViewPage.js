...
function TeacherDocumentViewPage({ classInfo }) {
  ...
  // Use classInfo prop if provided, otherwise use mock data
  ...
  const handleBack = () => {
    navigate(`/teacher/class/${classCode}/materials`);
  };
  ...
  return (
    <div className="teacher-document-page">
      ...
      <div className="teacher-document-page__content">
        ...
        <div className="teacher-document-page__main" style={{ justifyContent: 'center', alignItems: 'stretch', padding: 0 }}>
...
export default TeacherDocumentViewPage; 